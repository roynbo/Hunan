...
public class CarmodeActivity extends AppCompatActivity {
    ...
    public void setLayout(View v, double dx, double dy) {
        ...
        if(level==1)
        {creatCode(4,0,0,0,-f2*1,-f1*1,0,0);
            car_velocity_x.setText(df.format(-f2*1)+"m/s");
            car_velocity_y.setText(df.format(-f1*1)+"°/s");
