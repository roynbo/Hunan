...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_arm=(Button)findViewById(R.id.btn_arm);
        ...
        btn_arm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(MainActivity.this, NormalModeActivity.class);
                startActivity(intent1);
                overridePendingTransition(R.anim.zoom_enter, R.anim.zoom_exit);
                Toast.makeText(MainActivity.this, "摆臂微调！", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
